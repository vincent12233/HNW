...
export const tradingFields: FieldDef[] = [
  ...
  { key: "portfolio.stale_data", label: "组合旧数据提示", rows: 2 },
  { key: "portfolio.insufficient_history", label: "组合历史数据不足提示", rows: 2 },
  { key: "portfolio.no_activity", label: "组合暂无活动提示", rows: 2 },
  { key: "portfolio.day_return_note", label: "组合当日收益说明", rows: 2 },
  { key: "portfolio.asset_details_heading", label: "资产详情标题", rows: 1 },
  { key: "portfolio.holdings_heading", label: "产品持仓标题", rows: 1 },
