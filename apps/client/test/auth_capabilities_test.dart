...
void main() {
  test(
    'international phones use the selected country and preserve explicit prefixes',
    () {
  ...
  test(
    'no enrollment hides biometric login and iOS displays its actual capability',
    () {
      expect(
        DeviceBiometrics.fromCapabilities(TargetPlatform.android, []),
        isNull,
      );
      expect(
        DeviceBiometrics.fromCapabilities(TargetPlatform.iOS, [
          BiometricType.face,
        ]),
        DeviceBiometric.face,
      );
      expect(
        DeviceBiometrics.fromCapabilities(TargetPlatform.iOS, [
          BiometricType.fingerprint,
        ]),
        DeviceBiometric.fingerprint,
      );
      expect(
        DeviceBiometrics.fromCapabilities(TargetPlatform.android, [
          BiometricType.weak,
