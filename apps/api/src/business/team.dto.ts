...
import { IsBoolean, IsIn, IsInt, IsOptional, IsString, Length, Matches, MaxLength, Min, Max } from 'class-validator';
export class InvitePoolDto { @IsInt() @Min(1) @Max(100) count: number; }
...
export class TeamPasswordDto { @IsString() @Length(6,72) newPassword: string; }
