...
type Company = { id: string; name: string; tagline: string; description: string; logoUrl?: string; videoUrl?: string; websiteUrl?: string; sector?: string; status: string; sortOrder: number };
