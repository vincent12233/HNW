  ...
  Widget _verificationCard() => Container(
    ...
    child: Column(
      ...
      children: [
        ...
        const Text(
          'Choose an identity document and upload a clear copy for verification.',
          style: TextStyle(
        ...
        SegmentedButton<String>(
          ...
          onSelectionChanged: (values) =>
              setState(() => documentType = values.first),
        ),
        const SizedBox(height: 18),
        InkWell(
          onTap: isSubmitting ? null : _pickFile,
          borderRadius: BorderRadius.circular(18),
          child: Container(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 10),
                Text(
                  selectedFile?.name ?? 'Tap to choose your document',
                  textAlign: TextAlign.center,
                  maxLines: 2,
