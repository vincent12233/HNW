...
export const APP_CONTENT_DEFAULTS: DefaultContent[] = [
...

  {
    ...
    body: 'Institutional stocks settle at the live market price. Admin reference prices are display-only. Review eligibility and terms before trading.',
    locale: 'en',
    sortOrder: 60,
  },
  {
    ...
    body: 'संस्थागत शेयर लाइव बाज़ार कीमत पर निपटाए जाते हैं। व्यवस्थापक संदर्भ कीमत केवल प्रदर्शन के लिए है। ट्रेड से पहले पात्रता और शर्तें देखें।',
    locale: 'hi',
    sortOrder: 60,
  },
  {
