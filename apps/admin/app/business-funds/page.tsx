...
import { Alert, Card, Col, Input, Row, Space, Statistic, Table, Tabs, Tag, Typography } from "antd";
...
function customerLine(record: DepositRecord | WithdrawalRecord) {
  return (
...
export default function BusinessFundsPage() {
  ...
  const loanColumns: ColumnsType<LoanRecord> = [
    { title: "客户编号", dataIndex: "customerNo", width: 140 },
    { title: "客户", dataIndex: "customerName", width: 180 },
    { title: "贷款金额", dataIndex: "amount", width: 150, align: "right", render: formatMoney },
        ...
        <Card>
          ...
          <Tabs
            items={[
              ...
              { key: "loans", label: "客户贷款", children: <Table<LoanRecord> rowKey="id" columns={loanColumns} dataSource={loanRows} pagination={false} /> },
            ]}
          />
        </Card>
      </Space>
