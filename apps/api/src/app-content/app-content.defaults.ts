...
export const APP_CONTENT_DEFAULTS: DefaultContent[] = [
  ...
  {
    module: AppContentModule.TRADING,
    key: 'portfolio.stale_data',
    body: 'Showing previously loaded portfolio data.',
    locale: 'en',
    sortOrder: 593,
  },
  {
    module: AppContentModule.TRADING,
    key: 'portfolio.stale_data',
    body: 'पहले लोड किया गया पोर्टफोलियो डेटा दिखाया जा रहा है।',
    locale: 'hi',
    sortOrder: 593,
  },
  {
    module: AppContentModule.TRADING,
    key: 'portfolio.insufficient_history',
    body: 'Insufficient history',
    locale: 'en',
    sortOrder: 594,
  },
  {
    module: AppContentModule.TRADING,
    key: 'portfolio.insufficient_history',
    body: 'पर्याप्त इतिहास उपलब्ध नहीं है',
    locale: 'hi',
    sortOrder: 594,
  },
  {
    module: AppContentModule.TRADING,
    key: 'portfolio.no_activity',
    body: 'No product activity yet',
    locale: 'en',
    sortOrder: 595,
  },
  {
    module: AppContentModule.TRADING,
    key: 'portfolio.no_activity',
    body: 'अभी कोई उत्पाद गतिविधि नहीं है',
    locale: 'hi',
    sortOrder: 595,
  },
  {
    module: AppContentModule.TRADING,
    key: 'portfolio.day_return_note',
    body:
  ...
  },
  {
    ...
    key: 'portfolio.day_return_note',
    body:
      'आज का रिटर्न उपलब्ध नहीं है। इस उत्पाद सारांश में दैनिक P&L फ़ील्ड नहीं है।',
    locale: 'hi',
    sortOrder: 653,
  },
  {
    module: AppContentModule.TRADING,
    key: 'portfolio.asset_details_heading',
    body: 'Asset Details',
    locale: 'en',
    sortOrder: 654,
  },
  {
    module: AppContentModule.TRADING,
    key: 'portfolio.asset_details_heading',
    body: 'परिसंपत्ति विवरण',
    locale: 'hi',
    sortOrder: 654,
  },
  {
    module: AppContentModule.TRADING,
    key: 'portfolio.holdings_heading',
    body: 'Holdings and Positions',
    locale: 'en',
    sortOrder: 655,
  },
  {
    module: AppContentModule.TRADING,
    key: 'portfolio.holdings_heading',
    body: 'होल्डिंग्स और पोज़ीशन',
    locale: 'hi',
    sortOrder: 655,
  },
  {
    module: AppContentModule.TRADING,
    key: 'portfolio.holdings_caption',
    body:
  ...
  },
  {
    ...
    key: 'portfolio.holdings_caption',
    body:
      'वर्तमान पोर्टफोलियो प्रतिक्रिया से उत्पाद होल्डिंग्स। इक्विटी पोज़ीशन ट्रेड के अंतर्गत रहती हैं।',
    locale: 'hi',
    sortOrder: 656,
  },
  {
    module: AppContentModule.TRADING,
    key: 'portfolio.performance_heading',
    body: 'Performance',
    locale: 'en',
    sortOrder: 657,
  },
  ...
  {
    module: AppContentModule.TRADING,
    key: 'portfolio.no_holdings',
    body: 'No product holdings in the current response.',
    locale: 'en',
    sortOrder: 658,
  },
  {
    module: AppContentModule.TRADING,
    key: 'portfolio.no_holdings',
    body: 'वर्तमान प्रतिक्रिया में कोई उत्पाद होल्डिंग नहीं है।',
    locale: 'hi',
    sortOrder: 658,
  },
