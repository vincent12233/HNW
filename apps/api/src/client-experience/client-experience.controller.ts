...
export class ClientExperienceController {
  ...
  @Get('client/profile') @Roles(UserRole.CLIENT) profile(@Req() req: any) {
  ...
  @Get('client/bank-accounts') @Roles(UserRole.CLIENT) banks(@Req() req: any) {
