...
export class CompanyShowcaseService {
  ...
  listPublic() { return this.prisma.companyShowcase.findMany({ where: { status: 'ACTIVE' }, orderBy: [{ sortOrder: 'asc' }, { createdAt: 'desc' }] }); }
  ...
  create(body: any) { return this.prisma.companyShowcase.create({ data: this.data(body) }); }
